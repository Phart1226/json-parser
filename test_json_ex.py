...
class TestJsonEx(unittest.TestCase):
	...
	def test_check_first_letter(self):
		self.assertEqual(check_first_letter('Tx', 'Texas'), 'Tx letter passes')
		self.assertEqual(check_first_letter('mn', 'Minnasota'), 'mn letter FAILS')
		self.assertRaises(IndexError, check_first_letter, 'Tx', '')
